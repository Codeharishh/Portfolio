      ...
      >
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/2 mt-12 md:mt-24 space-y-2 order-2 md:order-1">
            ...
            <p className="text-sm md:text-md text-justify">
              I'm a software developer and web developer passionate about competitive programming and
              mastering data structures. My skill set includes C, C++ and
              Python for languages, along with HTML, CSS, JavaScript, and React
              JS , UI/UX designing for frontend development. You can find my
              projects and contributions on
              <a
                href="https://github.com/Codeharishh"
                target="_blank"
            ...
            <div className="flex flex-col items-center md:flex-row justify-between space-y-6 md:space-y-0">
              <div className="  space-y-2">
                ...
                <ul className="flex space-x-5">
                  ...
                  <li>
                    <a
                      href="https://www.linkedin.com/in/sriharish3012/"
                      target="_blank"
                    >
